  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl bg-white p-6 shadow-sm border border-civic-200">
        <h2 className="text-2xl font-bold text-civic-800 mb-3">Admin Dashboard</h2>
        <p className="text-gray-600">Manage platform operations, monitor roles, and ensure quality communication.</p>
      </section>

      <section className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-3xl bg-civic-50 p-5 border border-civic-200">
          <h3 className="text-lg font-semibold text-civic-700 mb-3">All Issues</h3>
        ...
        <div className="rounded-3xl bg-civic-50 p-5 border border-civic-200">
          <h3 className="text-lg font-semibold text-civic-700 mb-3">All Feedback</h3>
          <div className="mt-4 space-y-3">
            {feedback.map((item) => (
        ...
        <div className="rounded-3xl bg-civic-50 p-5 border border-civic-200">
          <h3 className="text-lg font-semibold text-civic-700 mb-3">Platform Updates</h3>
          <div className="mt-4 space-y-3">
            {updates.map((update) => (
